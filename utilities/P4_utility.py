...
import numpy as np
import sys,shutil
from ..src.inputs import get_h2_s2_integral_files_path, get_p4_s2_integral_files_path
...
nso = 8  # Number of spin-orbitals = 4/8/8(H2/P4/C2H4)
ne  = 4  # Number of electrons = 2/4/4(H2/P4/C2H4)
...
# For P4
integral_file = get_p4_s2_integral_files_path()
